...
class SnakePlayer(list):
	...
	def eyes(self):
		...
		foodahead = [self.getAheadLocation()in self.food,self.get2headLocation(self.body[0],2) in self.food]
		return  [self.direction==a for a in [0,1,2,3]] + foodahead+ self.sonar()
