...
import pickle
import visualize
from snakePlayerHiddenFood import SnakePlayer
import sys
...
def eval_genome(genome, config):
    ...
    genome.fitness = mean([runGame(net),runGame(net),runGame(net),runGame(net),runGame(net),runGame(net)])
